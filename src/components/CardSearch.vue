  ...
  <div class="card bg-white rounded-lg shadow-md p-4 mb-4">
    ...
    <div v-if="isPopupVisible" class="fixed inset-0 flex items-center justify-center backdrop-blur">
      <div class="popup bg-white p-6 rounded-lg shadow-lg scale-up">
        ...
        <p>Do you want to send a request to {{ userName }} for this product?</p>
...
export default {
  ...
  props: {
    ...
    userName: String,
    rewardAmount: String,
    cardId: { type: String, required: true }, // Unique card ID
  },
  setup(props) {
    ...
    const closePopup = () => {
      ...
      router.push('/'); // Optionally, navigate back or refresh the route
    };
