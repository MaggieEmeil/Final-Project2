...
<div class=" max-h-full fixed inset-0 backdrop-blur-3xl shadow-black shadow-md flex items-center justify-center z-50">
      <div class=" p-6 rounded-md bg-yellow-100 shadow-lg shadow-black hover:shadow-gray-200 sm:w-3/4  lg:w-2/5 md:w-3/4" @submit.prevent='input'>
 ...
 <form >
        <div class=" mt-6 flex items-center ms-20 lg:ms-0">
              ...
              <input name="item name" type="text"  class="ml-28 md:me-30   bg-white border border-gray-300 text-gray-800 text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter item name" v-model="ItemName" />
        </div>
         <div class="mt-6 flex items-center ms-20 lg:ms-0">
             <label class="font-semibold  text-gray-800 text-md mb-2 block">Item Quantity</label>
             <div class="bg-blue-200  flex items-center text-center rounded-full ml-28">
             ...
             <button @click="inc" type="button"  class="flex items-center justify-center me-2 align-center rounded-full text-white bg-gradient-to-r from-sky-900 to-sky-600  p-3 h-8 "><span class="text-md font-lg  font-bold  text-center flex justify-center pb-1">+</span></button>
             </div>
        </div>
        <div class="mt-6  flex items-center ms-20 lg:ms-0">
        ...
        <label class="font-semibold text-gray-800 text-md mb-2 block ml-16">Total({{ price }})</label>
        </div>
         <div class="mt-6  flex items-center ms-20 lg:ms-0">
              <input name="item name" type="number"  class="w-64 items-center bg-white border border-gray-300 text-gray-800 text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Single Item Weight" v-model="kilo" />
