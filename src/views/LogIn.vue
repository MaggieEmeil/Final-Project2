<template>
 <div class="font-[sans-serif]  bg-right-bottom bg-cover bg-[url('../images/airplane.jpg')]  bg-no-repeat flex items-center mx-auto md:h-screen p-4">
      ...
      <div class="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl bg-gradient-to-r from-yellow-100 to-yellow-50 overflow-hidden">
        <div class="max-md:order-1 flex flex-col justify-center space-y-16 max-md:mt-16 min-h-full bg-gradient-to-r   from-blue-800 to-blue-400 lg:px-8 px-4 py-4">
          <div>
            <h4 class="text-white text-lg font-semibold ">Enter Your Account</h4>
            <p class="text-[16px] text-white mt-3 leading-relaxed">Welcome to our sign-in page! Get started by entering your account.</p>
          </div>
 ...
 <div>
          ...
          <div class="!mt-12">
            <button type="button" class="w-full py-3 px-4 tracking-wider text-sm rounded-md text-white bg-gradient-to-r from-orange-500 to-orange-400 hover:bg-gray-800 focus:outline-none">
              Login
            </button>
          </div>
          <p class="text-gray-800 text-sm mt-6 text-center">Don't have an account? <a href="javascript:void(0);" class="text-blue-600 font-semibold hover:underline ml-1">Sign up here</a></p>
        </form>
      </div>
      </div>
    </div> 
